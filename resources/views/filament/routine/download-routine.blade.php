...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        td.time-cell { background-color: #f3f4f6; font-weight: bold; font-size: 9px; text-align: left; width: 90px; }
                ...
                <tr>
                    <td class="time-cell">
                        ...
                        <span style="font-weight:normal; font-size:8px;">
                            {{ \Carbon\Carbon::parse($slot->start_time)->format('h:i A') }} &ndash;
                            {{ \Carbon\Carbon::parse($slot->end_time)->format('h:i A') }}
                        </span>
                    </td>
                    @foreach (array_keys($days) as $dayIndex)
